...
const mainImgUrl = "https://www.vertticegr.com.br/wp-content/uploads/2024/05/Grupo-489.png";
const secondaryImgUrl = "https://www.vertticegr.com.br/wp-content/uploads/2024/05/Elipse-3.svg";
		...
		<div className="relative w-full max-h-full flex justify-center mt-[5%]">
			<div className="relative flex gap-4 max-w-[95%] 2xl:max-w-[70%] max-h-full">
				<div className="flex flex-col gap-4 flex-1 z-20">
					<p className="text-lg">Tecnologia e experiência</p>
					<p className="text-5xl font-bold">Aliadas para sua tranquilidade</p>
					<p className="text-sm">
						Temos um conjunto personalizado de soluções em Gestão de Riscos para
						ajuda-lo a conquistar mais segurança em todas as etapas de sua
					...
					">
						<Link href="/form">Cadastrar Motorista</Link>
					</Button>
				</div>
